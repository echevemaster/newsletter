...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table(u'mails_mailtemplate', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('name', self.gf('django.db.models.fields.CharField')(max_length=255)),
            ('content', self.gf('django.db.models.fields.TextField')()),
            ('date', self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True, blank=True)),
        ))
        db.send_create_signal(u'mails', ['MailTemplate'])
        ...
        db.create_table(u'mails_mail', (
            ...
            ('sent', self.gf('django.db.models.fields.BooleanField')()),
            ('template', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['mails.MailTemplate'])),
    ...
    def backwards(self, orm):
        ...
        db.delete_table(u'mails_mailtemplate')
    ...
    models = {
        ...
        u'mails.mail': {
            ...
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'sent': ('django.db.models.fields.BooleanField', [], {}),
            'subject': ('django.db.models.fields.CharField', [], {'max_length': '255'}),
            'template': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['mails.MailTemplate']"}),
            'to': ('django.db.models.fields.TextField', [], {})
        },
        u'mails.mailtemplate': {
        ...
        u'oauth2.client': {
            ...
            'client_id': ('django.db.models.fields.CharField', [], {'default': "'2ac4ee720440d2c9d2ce'", 'max_length': '255'}),
            'client_secret': ('django.db.models.fields.CharField', [], {'default': "'7f2a168b1538e9ebbeca84ae133a4dc2c74c4b8b'", 'max_length': '255'}),
